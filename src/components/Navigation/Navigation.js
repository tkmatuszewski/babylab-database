...
const Navigation = () => {
  ...
  const menu = classNames("navigation__list", {
    active: showMenu,
  });
  const sidebar = classNames("navigation__container", {
    active: showMenu,
  });
  const page = classNames("database__page", {
    active: showMenu,
  });
  ...
  return (
    <div className={navigation}>
      ...
      <div className={sidebar}>
        <div className="navigation__darken">
          <div className="navigationMsg">
            <h3 className="navigationMsg__title">Menu</h3>
          </div>
          <nav className={menu}>
            <NavigationItem name={"Home"} value={home} closeNav={setShowMenu} />
            <NavigationItem
              name={"Nowy badany"}
