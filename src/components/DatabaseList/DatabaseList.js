...
const DatabaseList = ({loading, data, setData, dataDefault, dataPasser, setDimBg}) => {
    ...
    const handleSelected = () => {
        ...
        const selectedChildren = data.filter(child => child.data.data().selected === true)
    ...
    return (
        <div className="databaseData__list">
            <aside className="databaseData__list__setup">
                ...
                <div onClick= {()=>toggleButton(setShowNotifications,setShowSelected, showNotifications)} className={notificationsButton}>
